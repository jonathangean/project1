class PoemController < ApplicationController
  ...
  string = shuffle88_arr[rand(58..60)..rand(61..72)].join(" ").gsub(/[.()""]/, ' ')
  ...
  @list_item1 = shuffle88_arr[rand(20..22)..rand(23..26)]
  @list_item2 = shuffle88_arr[rand(79..82)..rand(83..85)]
  @list_item3 = shuffle88_arr[rand(30..32)..rand(33..36)]
  @list_item4 = shuffle88_arr[rand(50..52)..rand(53..56)]
